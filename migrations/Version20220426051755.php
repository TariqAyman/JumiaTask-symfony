 ...
 */
final class Version20220426051755 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE country (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, regex VARCHAR(255) NOT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__customer AS SELECT id, name, phone FROM customer');
        $this->addSql('DROP TABLE customer');
        $this->addSql('CREATE TABLE customer (id INTEGER DEFAULT NULL, name VARCHAR(50) DEFAULT NULL, phone VARCHAR(50) DEFAULT NULL)');
        $this->addSql('INSERT INTO customer (id, name, phone) SELECT id, name, phone FROM __temp__customer');
        $this->addSql('DROP TABLE __temp__customer');
    }
}
